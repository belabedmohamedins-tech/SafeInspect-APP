...
export const baseGeneralCriteria: InspectionItem[] = [
  ...
  },
  {
    ...
    legalReference: 'المرسوم التنفيذي 91-05 المادة 13 (الحدود الدنيا للإضاءة في أماكن العمل — جدول مستويات الإضاءة اللازمة لكل نوع من أنواع المناصب) + القانون 88-07 المادة 5 (الوقاية من المخاطر المهنية وتحسين ظروف العمل).',
    severity: 'low',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
  ...
  },
  {
    ...
    legalReference: 'المرسوم التنفيذي 91-05 المادة 17 (سلامة التركيبات الكهربائية في أماكن العمل ووجوب مطابقتها لقواعد الوقاية) + القانون 88-07 المادة 5 (الوقاية من المخاطر المهنية وتحسين ظروف العمل).',
    severity: 'high',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
