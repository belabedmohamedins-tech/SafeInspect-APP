...
export const slaughterhouseSmallCriteria: InspectionItem[] = [
  {
    ...
    legalReference: 'المادتان 5 ࠆ8 من المرسوم التنفيذي 06-198 المعدَّل بالمرسومين 22-167 و24-196 المتعلق بالتنظيم المطبق على المؤسسات المصنفة (نظام الترخيص والتصريح حسب درجة الخطر وحجم النشاط).',
    severity: 'high',
    controlType: 'doc',
  ...
  },
  {
    ...
    legalReference: 'المادتان 15 ا27 من المرسوم 17-140 (منحدرات الأرضيات وقنوات الصرف في المنشآت الغذائية)، والمادة 12 من القانون 03-10 بخصوص منع تلوث المياه والأوساط الداخلية.',
    severity: 'high',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
  {
    ...
    legalReference: 'المادتان 35 ا36 من المرسوم التنفيذي 17-140 المتعلق بشروط النظافة والنظافة الصحية للمؤسسات الغذائية (ملابس العمل، سلوك المستخدمين، المنع الصريح للتدخين).',
    severity: 'high',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
