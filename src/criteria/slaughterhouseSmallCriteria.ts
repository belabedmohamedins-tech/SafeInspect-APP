...
export const slaughterhouseSmallCriteria: InspectionItem[] = [
  {
    ...
    legalReference: 'المادتان 5 و8 من المرسوم التنفيذي 06-198 المؤرخ في 31 مايو 2006 المتعلق بالتنظيم المطبق على المؤسسات المصنفة (نظام الترخيص والتصريح حسب درجة الخطر وحجم النشاط).',
    severity: 'high',
    controlType: 'doc',
  ...
  {
    // Phase 4.1: upgraded to numericField — MES threshold per Arrêté 15 oct 2011
    id: 'SLH-05-04',
    axis: 'مخلفات الذبح',
    category: 'بيئية',
    criteria: 'فصل الدم والأحشاء والمحتويات الصلبة عن مياه الغسل قبل وصولها إلى الحفرة المتعفنة أو شبكة الصرف، مع تجميعها في أوعية أو حاويات مخصصة. قياس المواد العالقة الكلية (MES) للمياه المصرَّفة والتحقق من عدم تجاوز الحد الأقصى المقرر (600 ملغ/ل).',
    legalReference: 'المادة 34 من القانون 01-19 المؤرخ في 12 ديسمبر 2001 المتعلق بتسيير النفايات ومراقبتها وإزالتها. المادة 12 من القانون 03-10 المتعلق بحماية البيئة (منع صرف مخلفات الذبح مباشرة دون معالجة). القرار الوزاري المشترك المؤرخ 15 أكتوبر 2011 (الحد الأقصى MES = 600 ملغ/ل عند التصريف).',
    severity: 'high',
    controlType: 'measurement',
    complianceStatus: 'not-evaluated',
    numericField: {
      unit: 'mg/L',
      labelAr: 'MES — المواد العالقة الكلية عند نقطة التصريف',
      min: 0,
      max: 600,
      warningMax: 400,
      step: 1,
