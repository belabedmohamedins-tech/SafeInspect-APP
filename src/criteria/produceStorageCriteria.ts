...
export const produceStorageCriteria: InspectionItem[] = [
  ...
  },
  {
    ...
    legalReference: 'المرسوم التنفيذي 17-140 المادة 15 و16 (الأرضيات والجدران: غير منفذة، قابلة للغسل، في حالة جيدة في منشآت التخزين الغذائي).',
    severity: 'high',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
  ...
  },
  {
    ...
    legalReference: 'المرسوم التنفيذي 17-140 المادتان 32 و33 (إزالة النفايات والمنتجات التالفة بسرعة من مناطق الحفظ الغذائي).',
    severity: 'high',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
