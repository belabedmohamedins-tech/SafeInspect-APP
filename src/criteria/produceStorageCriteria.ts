...
export const produceStorageCriteria: InspectionItem[] = [
  ...
  },
  {
    ...
    axis: 'شروط التخزين',
    category: 'صحية',
    criteria: 'تخزين الخضروات الطازجة في درجة حرارة تتراوح بين 0 و5Â°Ù… مع تهوية مناسبة.',
  ...
  },
  {
    ...
    axis: 'شروط التخزين',
    category: 'صحية',
    criteria: 'تخزين الزيتون في درجة حرارة تتراوح بين 7 و15Â°Ù… مع تهوية مناسبة.',
    legalReference: 'المرسوم التنفيذي 17-140 المادة 5 (مراقبة درجات الحرارة كنقطة تحكم حرجة) + القرارات الوزارية الخاصة بشروط حفظ المنتجات الفلاحية الطازجة.',
    severity: 'high',
    controlType: 'measurement',
    complianceStatus: 'not-evaluated',
