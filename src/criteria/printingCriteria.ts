...
export const printingCriteria: InspectionItem[] = [
  ...
  },
  {
    ...
    legalReference: 'القانون 88-07 المادة 5 (الوقاية من الحرائق والانفجارات في أماكن العمل) + المرسوم التنفيذي 91-05 المادة 57 (معدات مكافحة الحريق) + القانون 19-02 (الوقاية من الحريق في المحال التي تحتوي على مواد كيميائية قابلة للاشتعال).',
    severity: 'high',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
