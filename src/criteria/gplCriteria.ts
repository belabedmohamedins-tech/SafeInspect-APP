...
export const gplCriteria: InspectionItem[] = ([
  ...
  },
  {
    ...
    //   –” liste de matériel
    legalReference: 'المرسوم 83-496 المادة 7 (معدَّلة بالمرسوم التنفيذي 21-430 المادة 2: اشتراط شهادة التأهيل المهني الصادرة عن هيئة معتمدة، وشهادة مستوى تعليمي لا يقل عن السنة الرابعة متوسط، ووجود محل بمساحة لا تقل عن 60Ù…²ØŒ وقائمة بالمعدات اللازمة، كشروط لاعتماد مركب GPL/C) + المرسوم 83-496 المادة 8 (معدَّلة بالمرسوم التنفيذي 21-430 المادة 2: اشتراط الموافقة المسبقة للتجهيزات وشهادة التركيب قبل تسليم ترخيص الاستغلال).',
    severity: 'high',
    controlType: 'doc',
    complianceStatus: 'not-evaluated',
  },
