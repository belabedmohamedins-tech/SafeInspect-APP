...
export const gplCriteria: InspectionItem[] = [
  {
    ...
    legalReference: 'المرسوم التنفيذي 06-198 المادة 5 (رخصة الاستغلال للمؤسسات المصنفة) + المرسوم التنفيذي 21-430 المادة 3 (اشتراط الاعتماد المسبق من الوزارة المكلفة بالطاقة لمزاولة نشاط تركيب GPL/C).',
    severity: 'high',
    controlType: 'doc',
