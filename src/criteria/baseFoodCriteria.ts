...
export const baseFoodCriteria: InspectionItem[] = [
  ...
  // =====================================================================
  {
    ...
    axis: 'سلسلة البرودة',
    category: 'غذائية',
    criteria: 'الحفاظ على سلسلة البرودة للمنتجات المبردة: درجة حرارة التخزين بين 0°C و4°C مع وجود مقياس حرارة معيَّر داخل كل وحدة تبريد.',
    legalReference: 'القرار الوزاري المشترك المؤرخ في 07/05/2025 (اشتراطات درجة حرارة حفظ المواد الغذائية — المبردات: 0–4°C) + المرسوم التنفيذي 17-140 (السلامة الغذائية العامة).',
    severity: 'high',
