...
export const baseFoodCriteria: InspectionItem[] = [
  ...
  // =====================================================================
  // المحور 7: مكافحة الآفات (الغذائي) — Phase 8: سيُدمج لاحقاً في BGN-07-*
  //           BFD-07-01 و BFD-07-02 مؤقتان ريثما يُنجز Phase 8
  // =====================================================================
  {
    id: 'BFD-07-01',
    axis: 'مكافحة الآفات',
    category: 'نظافة',
    criteria: 'غياب أي مؤشر على وجود قوارض أو حشرات في مناطق التخزين والإنتاج.',
  ...
  },
  {
    ...
    axis: 'مكافحة الآفات',
    category: 'نظافة',
    criteria: 'وجود شبكات واقية على النوافذ والفتحات في مناطق تحضير الغذاء لمنع دخول الحشرات.',
    legalReference: 'المرسوم التنفيذي 17-140 (الاشتراطات الهيكلية للمنشآت الغذائية).',
    severity: 'medium',
    controlType: 'visual',
    complianceStatus: 'not-evaluated',
  },
