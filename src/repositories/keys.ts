...
// Single source of truth for all AsyncStorage / SecureStore key strings.
//
// Ownership rules:
...
//   APP_PIN             → AuthRepository — SecureStore (sole writer)
//   BIOMETRIC_ENABLED   → AuthRepository — SecureStore (sole writer)
//   PIN_FAILED_ATTEMPTS → AuthRepository — AsyncStorage (sole writer)
