...
## Local-PDF recovery update — 2026-08-20 — `loi-05-12-ressources-en-eau.md`

The previously unpaired Markdown was matched to `loi 05-12.pdf`. The 16-page source establishes Law n° 05-12 dated 4 August 2005 and contains Articles 1–183, including the final promulgation provision. The source and Markdown were compared for identity, dates, article sequence, closing provisions, and critical numerical tokens; the article sequence and legal body align.
...
## Local-PDF recovery update — 2026-08-20 — `loi-88-07-hygiene-securite-medecine-travail.md`

The previously unpaired Markdown was matched to `Loi 88-07-Hygiene-securite-et-medecine-du-travail.pdf`. The 10-page source is complete and legible and contains Articles 1–47. The source and Markdown were compared for identity, dates, article sequence, closing provisions, and critical numerical tokens; the article sequence and legal body align.
