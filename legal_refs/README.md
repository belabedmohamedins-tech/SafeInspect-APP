...
> Aucun doublon dans d'autres dossiers — `docs/legal_sources/` n'existe plus.
...
|---|---|---|---|
| `loi-09-03-protection-consommateur.md` | Loi n° 09-03 du 25 février 2009 | Protection du consommateur et répression des fraudes | ⚠️ Partiel — Art.44–52 + Art.80–92 manquants (voir [MANQUANT]) |
...
| `Decret-17-140.md` | Décret exécutif n° 17-140 du 11 avril 2017 | Conditions et modalités d'exercice de l'activité de restauration | ✅ Texte intégral |
| `Decret-07-144.md` | Décret exécutif n° 07-144 du 19 mai 2007 | Nomenclature des installations classées pour la protection de l'environnement | ⚠️ Partiel — rubriques 1243–2922 manquantes (voir [MANQUANT]) |
| `decret-06-198-etablissements-classes.md` | Décret exécutif n° 06-198 du 31 mai 2006 | Établissements classés pour la protection de l'environnement | ✅ Texte intégral |
...
| `arrete-interministeriel-2016-criteres-microbiologiques.md` | Arrêté interminist. du 4 octobre 2016 | Critères microbiologiques des denrées alimentaires | ⚠️ Stub — texte intégral non extrait |
| `arrete-interministeriel-1999-temperatures-conservation.md` | Arrêté interminist. du 21 novembre 1999 | Températures et procédés de conservation par réfrigération / congélation / surgélation | ⚠️ Valeurs de référence — texte intégral non extrait |
