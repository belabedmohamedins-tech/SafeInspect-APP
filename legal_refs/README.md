...
## Tableau de bord — Audit baseline 2026-08-09

| Statut | Nombre | Fichiers |
|---|---|---|
| ✅ VÉRIFIÉ | 2 | `decret-07-144`, `decret-17-140` |
| ⚠️ NON VÉRIFIÉ | 18 | voir index ci-dessous |
...
- **2026-08-09 :** `decret-22-167-etablissements-classes-modification.md` et `decret-24-196-etablissements-classes-modification.md` ajoutés — structure un fichier par instrument pour D06-198 et ses modificatifs.
- **2026-08-09 :** `decret-76-35-igh-incendie.md`, `decret-02-427-prevention-risques-professionnels.md`, `decret-21-430-gpl-carburant.md` — ajoutés manuellement par l'utilisateur, indexés dans ce README.
